...
exports.default = exports.convert = exports.decimalToAnyBase = exports.anyBaseToDecimal = void 0;
/**
 * Convert from base 10 to any base.
 *
 * @api public
 */
function decimalToAnyBase(iNumber, oBase) {
 ...
 * @api public
 */
function anyBaseToDecimal(iNumber, iBase) {
 ...
 * @api public
 */
function convert(iNumber, iBase, oBase) {
    var _a;
    ...
    if (((_a = iNumber.match(/[0-9A-Z]/g)) === null || _a === void 0 ? void 0 : _a.length) !== iNumber.length) {
